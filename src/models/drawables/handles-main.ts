...
import { ICoords2D, IRotationMatrix, TransformType } from '../../services/svg-geometry-service';
...
export class HandlesMain implements IDOMDrawable<SVGGElement> {
    //#region Fields
        ...
        canvas: SvgCanvas) 
    {
        ...
        this.element.appendChild(selectionContainerEl);

        this.selectionEl = <SVGCircleElement>document
            .createElementNS(NS.SVG, "circle");
        this.element.appendChild(this.selectionEl);
        ...
        this.element.appendChild(this.arcsContainer);
        ...
        this.element.appendChild(this.modeContainer);
        ...
        this.element.appendChild(this.subModeContainer);
